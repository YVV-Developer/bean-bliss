          ...
          <div className="row margin-bottom-60">
            ...
            <div className="col-lg-4 col-md-4 tm-footer-div">
              ...
              <div className="tm-social-icons-container">
                <Link className="tm-social-icon" to="https://www.facebook.com/"><i><FontAwesomeIcon icon={faFacebook} /></i></Link>
                <Link className="tm-social-icon" to="https://www.facebook.com/"><i><FontAwesomeIcon icon={faXTwitter} /></i></Link>
                <Link className="tm-social-icon" to="https://www.linkedin.com/"><i><FontAwesomeIcon icon={faLinkedin} /></i></Link>
                <Link className="tm-social-icon" to="https://www.instagram.com/"><i><FontAwesomeIcon icon={faInstagram} /></i></Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <div>
        <div className="container">
          <div className="row tm-copyright">
            <p className="col-lg-12 small copyright-text text-center">Copyright &copy; 2084 Your Cafe House</p>
          </div>
        </div>
      </div>
    </footer>
